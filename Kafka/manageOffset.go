/*
Specify  the start point of  the offset,  ex:  oldest, newest

go run manageOffset.go -brokers="localhost:9092" -topic="test"

Date: 2015-08-24

Reference: https://github.com/Shopify/sarama/blob/master/tools/kafka-console-consumer/kafka-console-consumer.go
